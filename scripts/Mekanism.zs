...
craftingTable.addShaped("mekanism_jetpack", <item:mekanism:jetpack>, [
    [<item:the_vault:black_chromatic_steel_ingot>, <item:mekanism:ultimate_control_circuit>, <item:the_vault:black_chromatic_steel_ingot>],
    [<item:the_vault:chromatic_steel_ingot>, <item:mekanism:ultimate_chemical_tank>, <item:the_vault:chromatic_steel_ingot>],
    [<item:minecraft:air>, <item:the_vault:chromatic_steel_ingot>, <item:minecraft:air>]
]);

craftingTable.addShaped("mekanism_flamethrower", <item:mekanism:flamethrower>, [
    ...
    [<item:the_vault:black_chromatic_steel_ingot>, <item:minecraft:flint_and_steel>, <item:the_vault:black_chromatic_steel_ingot>],
    [<item:minecraft:copper_block>, <item:mekanism:ultimate_chemical_tank>, <item:minecraft:copper_block>]
]);
